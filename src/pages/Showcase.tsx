    ...
    <div className="showcase-container">
      ...
      <div className="showcase-grid">
        ...
        <Link to="/showcase/agent-vision" className="showcase-card">
          ...
          <p className="card-description">
            AI-powered scene analysis with VLM integration and protocol management
          </p>
          <div className="card-tags">
            <span className="tag">Moondream VLM</span>
            <span className="tag">Protocol Status</span>
            <span className="tag">Real-time</span>
          </div>
          <div className="card-footer">
            <span className="card-action">View Demo →</span>
        ...
        {/* Live Webcam Detection Card - NEW */}
        <Link to="/showcase/webcam" className="showcase-card">
          <div className="card-icon">🎥</div>
          <h2 className="card-title">Live Webcam Detection</h2>
          <p className="card-description">
            Real-time object detection using your local webcam with ML overlay
          </p>
          <div className="card-tags">
            <span className="tag">MediaDevices API</span>
            <span className="tag">Real-time ML</span>
            <span className="tag">Canvas Overlay</span>
          </div>
          <div className="card-footer">
            <span className="card-action">Start Camera →</span>
          </div>
        </Link>
